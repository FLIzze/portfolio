    ...
    return (
        <div>
            <div className="lg:px-20 px-6 md:px-12 lg:h-screen h-full lg:overflow-y-auto mt-10 bg-black lg:bg-transparent md:text-xl text-base">
                <h1 className="text-4xl font-bold text-green-500 mb-6">Revenge on Inove</h1>
                ...
                <h2 className="text-2xl text-green-500 font-bold">Controles</h2>
                ...
                <h2 className="text-2xl text-green-500 font-bold">Déroulement du jeu</h2>
                <ul className="list-disc ml-10 mb-8">
                ...
                <div className="pb-16">
                    ...
                    <a href="/revenge-on-Inove/elevator.gif" target="blank">
                        <img src="/revenge-on-Inove/elevator.gif" alt="elevator gif" className=" bg-white p-2" width={1920} height={1080} draggable="false"/>
                    </a>
                </div>
            </div>
        </div>
