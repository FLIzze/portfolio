const ImpostorBot: React.FC<Fields> = ({fields, usedField}) => {
    return (
        <div>
            {fields[usedField] == "Impostor Bot" && (
                <div className="px-20 h-screen overflow-y-auto mt-10 text-xl">
                    ...
                    <div className="mt-8 flex justify-center">
                        <div>
                            ...
                            <img src="/impostor-bot/register.png" alt="register" className="h-fit mb-4 w-full"/>
                            <p className="flex justify-center text-green-400 mb-4 text-xl font-bold">[/Profile]</p>
                            <img src="/impostor-bot/profile.png" alt="profile" className="h-fit mb-4 w-full"/>
                            <p className="flex justify-center text-green-400 mb-4 text-xl font-bold">[Ordres]</p>
                            <img src="/impostor-bot/droide.png" alt="droide" className="h-fit mb-4 w-full"/>
                            <img src="/impostor-bot/super-hero-role.png" alt="super-hero" className="h-fit mb-4 w-full"/>
                            <p className="flex justify-center text-green-400 mb-4 text-xl font-bold">[Votes]</p>
                            <img src="/impostor-bot/game-end.png" alt="game end" className="h-fit mb-16 w-full"/>
                        </div>
                    </div>
                </div>
                )}
